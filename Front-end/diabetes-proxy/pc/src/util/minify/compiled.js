...
function toArray(obj) {
  var body = "";
  for (var i in obj) body += i + "=" + obj[i] + "&";
  if (body.length > 1) body = body.substr(0, body.length);
  return body;
}
function getPath() {
  // return "https://120.26.49.225:5098";
  return "http://120.26.49.225:5097";
  // return "https://develop.iot-expeed.com:5098"
}
var $$;
function toPOST(http, data, cb) {
  $$.ajax({
    url: getPath() + http,
    method: "POST",
    headers: {
